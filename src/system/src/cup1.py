...
class CupPlacementController:
    ...
    def run_main_logic(self):
        ...
        x_pos, y_pos = self.rotate_passive_deg(-105, 100, self.received_angle)
        rospy.sleep(0.01)
        ...
        movetotray         = [ -11 + self.Yg0 - y_pos, 660 + self.Xg0 + x_pos, 450, 180,  90, -90]
        movetotray_down    = [ -11 + self.Yg0 - y_pos, 660 + self.Xg0 + x_pos, 130, 180,  90, -90]
