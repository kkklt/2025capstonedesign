...
class ArucoMotionController:
    ...
    def execute_path(self):
        ...
        for (x, y, z) in self.received_path:
            ...
            self.moveline(posx, vel, acc, self.get_scaled_time(2.0))
    ...
    def run_main_logic(self):
        ...
        time.sleep(self.get_scaled_time(1.0)) # ✅
        ...
        pos_down2 = [-206+self.Yg0+4, 660+self.Xg0+1, 255, 0, 180, 90]
        pos_basic = [-206, 660, 500, 0, 180, 90]
        
        back = [400, 500, 500, 0, 180, 180]
        ...
        while not rospy.is_shutdown():
            ...
            pos_down = [-206+self.Yg0+4, 660+self.Xg0+1, 256, 0, 180, angle_with_offset]
            pos_up = [-206+self.Yg0+4, 660+self.Xg0+1, 500, 0, 180, angle_with_offset]
            finish = [1000, 400, 257, 0, 180, 180]
            finish_up = [1000, 400, 500, 0, 180, 180]
