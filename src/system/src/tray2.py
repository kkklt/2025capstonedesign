...
class ArucoMotionController:
    ...
    def run_main_logic(self):
        ...
        pos       = [-536 + self.Yg0 + 4, 660 + self.Xg0 + 1, 500, 0, 180,  90]
        pos2      = [-536 + self.Yg0 + 4, 660 + self.Xg0 + 1, 500, 0, 180, 180]
        ...
        while not rospy.is_shutdown():
            ...
            pos_with_rotation = [-536 + self.Yg0 + 4, 660 + self.Xg0 + 1, 500,   0, 180, angle_with_offset]
            pos_down          = [-536 + self.Yg0 + 4, 660 + self.Xg0 + 1, 273,   0, 180, angle_with_offset]
            pos_up            = [-536 + self.Yg0 + 4, 660 + self.Xg0 + 1, 500,   0, 180, angle_with_offset]
